import { getBottoms, getFaces, getHands, getHats, getSkins, getTops } from '@/api/avatar';
import { queryKeys } from '@/constants';
import { useQueries } from '@tanstack/react-query';

function useGetAvatarItems() {
  const [hatsQuery, facesQuery, topsQuery, bottomsQuery, handsQuery, skinsQuery] = useQueries({
    queries: [
      {
        queryFn: getHats,
